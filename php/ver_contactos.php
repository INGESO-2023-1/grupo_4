...
<body>
  ...
  <div id="container-main" class="d-flex justify-content-center align-items-center flex-column">
    <h2 class="text-center my-4"> Lista de contactos de 
    <?php
    session_start();
      ...
      <div class="col-sm">
        <div class="card mb">
          <div class="card-body">
            ...
            $sql = "SELECT id_contacto FROM contactos WHERE id_user = :id_user";
            $sql .= " ORDER BY (SELECT username FROM usuarios WHERE id = contactos.id_contacto) ASC";
            $query = $base->prepare($sql);
            ...
            if (!empty($resultados)) {
              foreach ($resultados as $resultado) {
                $id_contacto = $resultado['id_contacto'];
